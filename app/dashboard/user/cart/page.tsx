...
export default function CartPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-amber-50">
      {/* Sidebar */}
      <aside className="w-full lg:w-64 bg-white/80 backdrop-blur-sm shadow-xl border-r border-orange-100 p-3 sm:p-4 lg:h-screen overflow-y-auto">
