...
export default function UserProfilePage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-gradient-to-br from-gray-50 via-teal-50 to-cyan-50">
      {/* Sidebar */}
      <aside className="w-full lg:w-64 bg-white/80 backdrop-blur-sm shadow-xl border-r border-teal-100 p-3 sm:p-4 lg:h-screen overflow-y-auto">
