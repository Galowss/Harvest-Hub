    ...
    <main className="relative flex items-center justify-center min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 p-4 overflow-hidden">
      ...
      <form onSubmit={handleSignUp} className="relative bg-white/80 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-2xl w-full max-w-sm sm:max-w-6xl border border-green-100">
        ...
        <div className="lg:flex lg:items-start lg:gap-12 lg:mb-6">
          <div className="lg:w-1/3 lg:sticky lg:top-0 lg:pr-8 lg:border-r lg:border-emerald-200">
            ...
            <h1 className="text-lg sm:text-xl lg:text-3xl font-bold mb-4 text-center lg:text-left bg-gradient-to-r from-emerald-700 via-green-600 to-teal-600 bg-clip-text text-transparent">
              Sign Up as Farmer
            </h1>

            <p className="hidden lg:block text-sm lg:text-base text-gray-600 mb-6 leading-relaxed">
              Join HarvestHub to showcase your products, reach more customers, and grow your farming business.
            </p>
            ...
            <div className="hidden lg:block space-y-3 text-sm text-gray-600">
              <div className="flex items-start gap-3">
                ...
                <span>Showcase your products online</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            ...
            <div className="hidden lg:block mt-8 p-4 bg-blue-50 border border-blue-200 rounded-xl">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-xs text-gray-700">
                  ...
                  <p>By creating an account, you agree that HarvestHub will collect and process your personal information (name, email, contact number, farm address) to provide our marketplace services, facilitate transactions, connect you with customers, and improve your user experience. Your data will be stored securely and used in accordance with the Data Privacy Act of 2012 (Republic Act No. 10173). We will not share your information with third parties without your consent.</p>
                </div>
              </div>
            </div>
          </div>
